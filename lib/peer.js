 ...
 * using the standard Devault protocol. A Peer instance represents one connection
 * on the Devault network. To create a new peer connection provide the host and port
